...
<body class="bg-dark">
  ...
  <div class="container">
    <div class="card card-login mx-auto mt-5">
      <div class="card-header">USINDA-SME Directory Management System || Admin Login</div>
      <div class="card-body">
    ...
    echo $msg;
        ...
        <div class="text-center">
          ...
          <p style="font-size:13px; color: red;">Test Credentials: username: admin Password: Test@123</p>
        </div>
      </div>
    </div>
  </div>
