...
if(isset($_POST['submit']))
  {
    ...
    $pdid=$_GET['editid'];
     $stats=$_POST['status'];
    $query=mysqli_query($con, "update tbldirectory set FullName='$fullname',Profession='$profession',Email='$email',MobileNumber='$mobilenumber',Address='$address',City='$city',Status='$stats' where ID=$pdid");
    if ($query) {
        ...
        <form name="directory" method="post">
          ...
          <div class="form-group">
            <div class="form-row">
              ...
              <div class="col-md-6">
                <div class="form-label-group">
                  <input type="text" id="city" name="city" class="form-control"  required="required" autofocus="autofocus" value="<?php echo $row['City'];?>">
                  <label for="firstName">Company Name - Product/Service</label>
                </div>
              </div>
          ...
          <div class="form-group">
            <div class="form-label-group">
              <input type="address" id="address" name="address" class="form-control"  required="required" value="<?php echo $row['Address'];?>">
              <label for="inputEmail">Enter Address-State-Zipcode</label>
            </div>
          </div>
